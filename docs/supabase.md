...
- The cellar tab renders a read-only 5 by 6 grid from `is_cellar`, `cellar_zone`, `row_num`, and `col_num`.
- `npm run seed:wines` upserts the sample cellar inventory from `supabase/seed-wines.json`.
